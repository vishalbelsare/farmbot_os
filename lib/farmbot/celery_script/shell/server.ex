defmodule Farmbot.CeleryScript.Shell.Server do
  @moduledoc """
  ...
  defp run(opts) when is_list(opts) do
    IO.puts """
    CeleryScript interactive Shell.
  ...
  def start_evaluator(opts) do
    ...
    evaluator = opts[:evaluator] || :proc_lib.start(Farmbot.CeleryScript.Shell.Evaluator, :init, [:ack, self_pid, self_leader, opts])
    evaluator
  end
end
